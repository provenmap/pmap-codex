...
Update **ProvenMap Architect** (`pmap-arch`) to the latest version published for
...
```bash
node ${PLUGIN_ROOT}/scripts/pmap-update.js --host codex --plugin-name pmap-arch --host-name "Codex"
```
