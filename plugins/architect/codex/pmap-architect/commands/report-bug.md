...
Help the user report a problem with **ProvenMap Architect**. Nothing is sent from here:
...
6. **Outcome:** `node ${PLUGIN_ROOT}/scripts/pmap-architect.js --brief --command report-bug` → one line, per `${PLUGIN_ROOT}/knowledge/outcome/SKILL.md`.
