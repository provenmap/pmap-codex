...
| **Plain layer**     | `isChildLayer`, no binding                                                                             | Orient normally, and say that facet work (work items) routes up to the owning app board.                                                        |
| **App board**       | has a code-plugin binding                                                                              | The full orientation sequence: `get_workboard_details`, `get_hub_status`, `list_work_items`, `list_insights`.                                    |
