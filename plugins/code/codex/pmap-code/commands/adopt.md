...
**Outcome:** `node ${PLUGIN_ROOT}/scripts/pmap-status.js --brief --command adopt --facts '{"aspect":"<kind>"}'` → Done · Left · Next, per `${PLUGIN_ROOT}/knowledge/outcome/SKILL.md`.
