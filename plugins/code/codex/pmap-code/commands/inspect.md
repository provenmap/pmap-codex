---
category: map
description: "Map · Visually inspect the running app — pick components in a real browser, capture screenshots and metadata that feed work items"
...
**Outcome:** `node ${PLUGIN_ROOT}/scripts/pmap-status.js --brief --command inspect` → Done · Left · Next, per `${PLUGIN_ROOT}/knowledge/outcome/SKILL.md`.
