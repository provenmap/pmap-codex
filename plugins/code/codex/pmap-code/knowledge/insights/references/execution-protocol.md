...
```bash
node ${PLUGIN_ROOT}/scripts/pmap-insights.js --save-insight /tmp/insight-<slug>.json --board-slug <pack.primaryBoardDefault> --require-pack --push --host codex --domain code
```
