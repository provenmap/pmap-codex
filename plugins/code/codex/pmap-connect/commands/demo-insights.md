...
```bash
node ${PLUGIN_ROOT}/scripts/pmap-insights.js --save-insight /tmp/insight-<slug>.json --board-slug <board> --demo --require-pack --push --host codex --domain connect
```
...
**Close:** `node ${PLUGIN_ROOT}/scripts/pmap-status.js --after demo-insights --domain connect` — print verbatim.
