...
Update **ProvenMap Work** (`pmap-work`) to the latest version published for
...
```bash
node ${PLUGIN_ROOT}/scripts/pmap-update.js --host codex --plugin-name pmap-work --host-name "Codex"
```
