...
Update **Prov Code** (`prov-code`) to the latest version published for
...
```bash
node ${PLUGIN_ROOT}/scripts/prov-update.js --host codex --plugin-name prov-code --host-name "Codex"
```
