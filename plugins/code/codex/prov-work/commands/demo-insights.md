...
```bash
node ${PLUGIN_ROOT}/scripts/prov-insights.js --list-insight-skills --board-slug <boardSlug>
```
...
```bash
node ${PLUGIN_ROOT}/scripts/prov-insights.js --build-context --board-slug <board> --demo --out .provenmap/insights/<board>.context.json --summary
```
...
```bash
node ${PLUGIN_ROOT}/scripts/prov-insights.js --save-insight /tmp/demo-insight-<slug>.json --board-slug <board> --demo --require-pack --push
```
