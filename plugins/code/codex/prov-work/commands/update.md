...
Update **Prov Work** (`prov-work`) to the latest version published for
...
```bash
node ${PLUGIN_ROOT}/scripts/prov-update.js --host codex --plugin-name prov-work --host-name "Codex"
```
